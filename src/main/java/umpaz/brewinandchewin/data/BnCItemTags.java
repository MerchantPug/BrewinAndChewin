...
public class BnCItemTags extends ItemTagsProvider {
    ...
    private void registerModTags() {
        tag(BnCTags.CHEESE_WEDGES).add(BnCItems.FLAXEN_CHEESE_WEDGE.get()).add(BnCItems.SCARLET_CHEESE_WEDGE.get());
        tag(BnCTags.PIZZA_TOPPINGS).addTag(ForgeTags.COOKED_BACON).addTag(ForgeTags.COOKED_BEEF).addTag(ForgeTags.COOKED_CHICKEN)
                .addTag(ForgeTags.COOKED_MUTTON).addTag(ForgeTags.COOKED_PORK).add(Items.BROWN_MUSHROOM).add(Items.RED_MUSHROOM)
