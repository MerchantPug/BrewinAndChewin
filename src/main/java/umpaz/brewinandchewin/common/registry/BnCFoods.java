...
public class BnCFoods {
    public static final FoodProperties BEER = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATED.get(), 2400, 0), 1.0F)
            .alwaysEat()
            .build();
    public static final FoodProperties VODKA = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATED.get(), 3600, 0), 1.0F)
            .alwaysEat()
            .build();
    ...
    public static final FoodProperties RICE_WINE = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATED.get(), 1500, 0), 1.0F)
    ...
    public static final FoodProperties PALE_JANE = (new FoodProperties.Builder())
            .effect(() -> new MobEffectInstance(BnCEffects.TIPSY.get(), 6000, 0), 1.0F)
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATED.get(), 300, 0), 1.0F)
    ...
    public static final FoodProperties STEEL_TOE_STOUT = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATED.get(), 3000, 0), 1.0F)
    ...
    public static final FoodProperties RED_RUM = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATED.get(), 5400, 0), 1.0F)
            .effect(() -> new MobEffectInstance(ModEffects.COMFORT.get(), 9600, 1), 1.0F)
            .alwaysEat()
            .build();
    public static final FoodProperties WITHERING_DROSS = (new FoodProperties.Builder())
            ...
            .effect(() -> new MobEffectInstance(BnCEffects.INTOXICATED.get(), 6000, 0), 1.0F)
